<?php
	...
	class controller{
		...
		function update(){
			...
			$update = $this->model->updateMhs($nim, $nama, $angkatan, $fakultas, $program,$genre,$wisata);//panggil model update mahasiswa
		...
		function insert(){
			...
			$insert = $this->model->insertMhs($nim, $nama, $angkatan, $fakultas, $program,$genre,$wisata);
