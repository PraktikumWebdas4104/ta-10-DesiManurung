<html>
	<head>
		<title>TA TERAKHIR SEMANGAT</title>
	</head>
	<body>
		...
		<form action="" method="POST">
			<table border="0" cellpadding="5" cellspacing="0" align="center">
				...
				<tr align="center">
					<td>Program studi</td>
					<td>:</td>
					<td><input type="text" name="program" value="<?=$row[4]?>" size="45"/></td>
				</tr>
				<tr >
					...
					<td>
						...
						<input type="checkbox" name="genre[]"  value="animasi" <?php  if(in_array("Drama",$genre)){echo "checked";}?>/>Drama <br>
					</td>
				</tr>
